...
/* appearance */
static const unsigned int border_px = 2; /* border pixel of windows */
...
static const char* colors[][3] = {
    ...
    [SchemeSel] = { col_gray4, col_gray1, col_accent }, // Selected scheme
};
...
static const char* cmd_rofi[] = { "rofi", "-modi", "drun,run", "-show", "drun", NULL };
static const char* cmd_terminal[] = { "kitty", NULL };
...
static const Key keys[] = {
    ...
    {           Mod4Mask,                XK_space,          spawn,     { .v = cmd_rofi } },
    {           Mod4Mask,               XK_Return,          spawn, { .v = cmd_terminal } },
